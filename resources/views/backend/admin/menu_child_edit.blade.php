...
<head>
  ...
  <title>Menu-Edit | Food App</title>
...
<!-- Main content -->
    <section class="content">
        <div class="container-fluid">
            ...
            <form action="{{url('admin/menu/child/update/'.$menu->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-12 col-md-12 mt-3 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id" class="form-control" required>
                                        @foreach($parents as $parentdata)
                                            @if($parentdata->id == $menu->category_id)
                                                <option value="{{$parentdata->id}}" selected>{{$parentdata->name}}</option>
                                            @elseif($parentdata->id != $menu->category_id)
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="class">Menu Name</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <img src="{{asset('uploads/images/menu_items/child/'. $menu->image)}}" class="img-fluid"><br><br>

                                    <label for="class">Change Image?<span><small> (Upload 900 x 600 pixel)</small></span></label>
                    ...
                    <a href="{{ route('menuchild.index') }}" class="btn btn-default">Cancel</a>
