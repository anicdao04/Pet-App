...
<section class="content">
        <div class="container-fluid">
            <div class="mb-3">
                <h3>Trivias</h3>
                <small><span class="text-primary">Trias</span> | List</small>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-5 col-md-4">
                    <div class="info-box">
                        <span class="info-box-icon bg-default elevation-1"><i class="fas fa-question"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">Total No. of Trivias</span>
                            <span class="info-box-number mt-0">
                            <span>{{ $trivia_count }}</span>
                            </span>
                        </div> 
                    </div> 
                </div> 
                ...
                <div class="col-12 col-md-12 mt-4">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">List of Trivias</h3>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                      ...
                                      <div class="dropdown-menu" style="font-size: .875rem !important; min-width: 0px !important" aria-labelledby="btnGroupDrop1">
                                        ...
                                        <a class="dropdown-item"  href="{{url('admin/trivia/modify/'.$data->id)}}"><i class="nav-icon fas fa-check mr-1"></i>Modify</a>
                                        <a class="dropdown-item"  href="{{url('admin/trivia/delete/'.$data->id)}}"><i class="nav-icon fas fa-trash mr-1"></i> Delete</a>
                                      </div>
                                    </div>
                                </td>
                                </tr> 
                    ...
                    <a href="{{ route('trivia.create') }}" class="btn btn-primary">Create</a>
                </div>
            </div> <!-- /row -->   
...
@if(Session::has('trivias_created'))
    <script>
        toastr.info("{!! Session::get('trivias_created') !!}");
    </script>
@elseif(Session::has('trivias_updated'))
    <script>
        toastr.success("{!! Session::get('trivias_updated') !!}");
    </script>
@elseif(Session::has('trivias_deleted'))
    <script>
        toastr.error("{!! Session::get('trivias_deleted') !!}");
    </script>
@endif
