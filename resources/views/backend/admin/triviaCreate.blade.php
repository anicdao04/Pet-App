...
<head>
  ...
  <title>Create Trivia | PetPal</title>
...
<section class="content">
        <div class="container-fluid">
            <div class="mb-3">
                <h3>Trivias</h3>
                <small>Please fill in this form to add this trivia.</small>
            </div>
            
         
            <form action="{{ url('admin/trivia/store') }}" method="post">
            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="header" value="{{ old('header')}}" class="form-control" required>  
