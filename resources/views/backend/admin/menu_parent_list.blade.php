...
<head>
  ...
  <title>Category-List | Food App</title>
...
<!-- Main content -->
    <section class="content">
        <div class="container-fluid">
            <div class="mb-3">
                <h3>List</h3>
                <p><span class="text-primary">Menu Items</span> | Parent</p>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-md-12 mt-3 mb-3">
                            ...
                            <tbody>
                              @foreach($menus as $data)
                                <tr>
                                    <td>{{$data->name}}</td> 
                                <td>
                                    <a href="" class="btn btn-default btn-sm mr-1">Modify</a>
                    ...
                    <a href="{{route('menuparent.create')}}" class="btn btn-primary">Create</a>
                </div>
            </div> <!-- /row -->   
